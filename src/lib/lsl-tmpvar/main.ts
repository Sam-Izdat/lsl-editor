...
} from "$lib/lsl-tmpvar/types"

// @ts-ignore

import LegitScriptCompiler from "$lib/vendor/LegitScriptWasm.js"
import type {
  ImageCache,
  ImageCacheAllocatedImage
} from "$lib/lsl-tmpvar/image-cache.js"
import {
  ImageCacheGetImage
} from "$lib/lsl-tmpvar/image-cache.js"
...
} from "$lib/lsl-tmpvar/webgl-shader-compiler.js"
import {
  CreateRasterProgram
} from "$lib/lsl-tmpvar/webgl-shader-compiler.js"

import { SourceAssembler } from "$lib/lsl-tmpvar/source-assembler.js"
import { initialContent, demoContent } from "$lib/lsl-tmpvar/initial-content.js"
import { ProcessScriptRequests, RunScriptInvocations, SetBlendMode } from "$lib/lsl-tmpvar/legit-script-io.js"
import { UIState } from "$lib/lsl-tmpvar/immediate-ui.js"
...
export async function CompileLegitScript(
...
export async function Init(
  ...
  if (!canvasEl || !controlsEl || !draggerEl) {
...
// const LegitScriptCompiler = await window.LegitScriptCompiler;
// console.log(window.LegitScriptCompiler);
  // import LegitScriptCompiler from "$lib/vendor/LegitScriptWasm.js"
  // const { default: Module } = await import('$lib/vendor/LegitScriptWasm.js');
  // console.log(Module);
